...
const de = {
  ...
  detail: {
    ...
    clearChecked: 'Entfernen',
    clearCheckedA11y: '{count} abgehakte Artikel entfernen',
    clearCheckedMenu: 'Abgehakte entfernen ({count})',
    crossedOff: '{name} abgehakt',
    clearPromptOne: '{count} abgehakten Artikel vom letzten Mal entfernen?',
    clearPromptOther: '{count} abgehakte Artikel vom letzten Mal entfernen?',
  ...
  settings: {
    ...
    siri: 'Siri',
    siriHint: 'Artikel per Sprache hinzufügen. Sag: "Add milk to Grocery List".',
    siriDefaultList: 'Standardliste',
    siriAskEachTime: 'Jedes Mal fragen',
  },
};
export default de;
