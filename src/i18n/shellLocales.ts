...
export const SHELL_LOCALES = {
  es: {
    ...
    about: { support: 'Apoyar esta app', supportShort: 'Apoyar', feedback: 'Enviar comentarios', review: 'Dejar una reseña', privacy: 'Privacidad', source: 'Código fuente', acknowledgements: 'Agradecimientos', version: 'Versión', oneLiner: 'Alternativas centradas en la privacidad a las apps de utilidades con muros de pago. Código abierto. Paga lo que quieras.', learnMore: 'Más información', learnMoreA11y: 'Más información en joshapproved.com' },
  ...
  de: {
    ...
    about: { support: 'Diese App unterstützen', supportShort: 'Unterstützen', feedback: 'Feedback senden', review: 'Bewertung abgeben', privacy: 'Datenschutz', source: 'Quellcode', acknowledgements: 'Danksagungen', version: 'Version', oneLiner: 'Datenschutzfreundliche Alternativen zu Utility-Apps mit Bezahlschranke. Open Source. Zahl, was du willst.', learnMore: 'Mehr erfahren', learnMoreA11y: 'Mehr erfahren auf joshapproved.com' },
  ...
  ja: {
    ...
    about: { support: 'このアプリを支援', supportShort: '支援', feedback: 'フィードバックを送る', review: 'レビューを書く', privacy: 'プライバシー', source: 'ソースコード', acknowledgements: '謝辞', version: 'バージョン', oneLiner: '有料の実用アプリに代わる、プライバシー重視のオープンソースアプリ。料金はお気持ちで。', learnMore: '詳しく見る', learnMoreA11y: 'joshapproved.com で詳しく見る' },
